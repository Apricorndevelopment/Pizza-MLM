    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-2xl font-bold text-slate-800">Product Banners</h3>
                    <p class="text-slate-500 text-sm">Manage banners displayed in the product section</p>
                </div>
            </div>
                        ...
                        @forelse($banners as $banner)
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="p-3 text-right flex justify-end gap-2">
                                    ...
                                    <form action="{{ route('admin.product.banners.destroy', $banner->id) }}" method="POST" onsubmit="return confirm('Delete this banner?');" class="inline">
                                        @csrf @method('DELETE')
    ...
    <script>
        ...
        function openModal(type, data = null) {
            ...
            if (type === 'create') {
                ...
                form.action = "{{ route('admin.product.banners.store') }}";
                ...
                form.action = `/admin/product-banners/update/${data.id}`;
