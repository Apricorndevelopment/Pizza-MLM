...
<head>
    ...
    <title>Admin Portal - FoodVendor</title>
...
<body class="flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <!-- Grid Pattern -->
        <div class="absolute inset-0" style="background-image: linear-gradient(rgba(59, 130, 246, 0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(59, 130, 246, 0.05) 1px, transparent 1px); background-size: 40px 40px;"></div>
        
        <!-- Floating Elements -->
        <div class="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-blue-500/10 blur-3xl floating"></div>
        <div class="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-blue-900/10 blur-3xl floating" style="animation-delay: 1s;"></div>
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="flex justify-center mb-4">
            <div class="admin-gradient text-white px-6 py-3 rounded-full font-semibold text-sm tracking-wider uppercase glow-effect">
        ...
        <div class="glass-panel rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="p-5 text-center border-b border-slate-700/50">
                <div class="flex items-center justify-center space-x-3 mb-2">
                    ...
                    <div class="text-left">
                        <h1 class="text-2xl font-bold text-white">FoodVendor</h1>
                        <p class="text-slate-400 text-sm">Administration System</p>
                    </div>
                </div>
                {{-- <h2 class="text-xl font-semibold text-white mb-2">Secure Admin Login</h2>
                <p class="text-slate-400 text-sm">Enter your credentials to access the admin dashboard</p> --}}
            </div>
            
            <!-- Messages -->
            <div class="px-6 pt-4">
                @if (session('success'))
                <div class="mb-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4 flex items-center space-x-3">
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('admin.login.post') }}" class="px-6 py-4 pt-4">
                @csrf
