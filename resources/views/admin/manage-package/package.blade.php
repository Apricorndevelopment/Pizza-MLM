            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 mb-8">
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('admin.package1.create') }}"
                                class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 w-full sm:w-auto transition-colors">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($package1 as $package)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">₹{{ $package->price }}
                                        </td>
                                        <td class="px-4 py-3 text-sm text-gray-500 truncate max-w-xs">
                                            {{ $package->description ?? 'N/A' }}</td>
                                        <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-2">
                                                <a href="{{ route('admin.package1.edit', $package->id) }}"
                                                    class="text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-md transition-colors">Edit</a>
