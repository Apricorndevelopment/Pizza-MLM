    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Create a new Type 1 package configuration</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex items-center">
                ...
                <h2 class="text-lg font-semibold text-white tracking-wide">Create Package Type 1</h2>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                    ...
                                    name="price" 
                                    value="{{ old('price') }}" 
                                    class="w-full pl-8 pr-4 py-2.5 rounded-lg border {{ $errors->has('price') ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-200' }} focus:ring-2 outline-none transition-all shadow-sm"
                                    placeholder="0.00"
                                    required>
                            </div>
                            @error('price')
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <textarea 
                                ...
                                name="description" 
                                rows="4" 
                                class="w-full px-4 py-2.5 rounded-lg border {{ $errors->has('description') ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-200' }} focus:ring-2 outline-none transition-all shadow-sm placeholder-gray-400"
                                placeholder="Enter package details...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}</p>
                            @enderror
                        </div>
