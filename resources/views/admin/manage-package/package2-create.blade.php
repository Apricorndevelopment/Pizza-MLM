...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('admin.package2.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <div class="bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 p-6 flex flex-col items-center justify-center text-center hover:bg-blue-50 hover:border-blue-400 transition-all cursor-pointer group h-full min-h-[250px]" id="drop-zone">
                        ...
                        {{-- Preview Container --}}
                        <div id="preview-area" class="hidden mt-4 bg-white rounded-xl border border-gray-200 shadow-sm p-3 relative group">
