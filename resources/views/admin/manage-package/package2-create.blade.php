                            ...
                            <div>
                                ...
                                <div>
                                    <input type="number"
                                        ...
                                        required id="maxCoupon" name="max_coupon_usage"
                                        value="{{ old('max_coupon_usage', 0) }}" min="0">
                            ...
                            <div id="capping-section" class="transition-all duration-300 {{ old('is_package_product') == '1' ? 'block' : 'hidden' }}">
                                <div class="relative">
                                    ...
                                    <input type="number" name="capping" id="capping-input"
                                        value="{{ old('capping', 0) }}" placeholder="Enter limit amount"
