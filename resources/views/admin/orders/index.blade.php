    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getOrderHtml(order) {
                ...
                const userUlid = order.user && order.user.ulid ? order.user.ulid : 'N/A'; // Yahan ULID fetch kar rahe hain
                ...
                <div class="order-card bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition-shadow duration-300 animate-fade-in">
                    <div class="px-4 md:p-4">
                        <div class="flex flex-col md:flex-row gap-6 md:items-center">
                            ...
                            <div class="w-full md:w-3/12 md:border-l md:border-slate-100 md:pl-6"><p class="text-[10px] uppercase tracking-wider font-bold text-slate-400 mb-1">Customer</p><div class="flex items-center gap-3"><div class="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 font-bold text-xs">${initial}</div><div><p class="text-sm font-bold text-slate-800">${userName}(${userUlid})</p><p class="text-[10px] text-slate-400">${userEmail}</p></div></div></div>
