        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.package2.store') }}" method="POST" id="packageForm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <h5 class="border-bottom pb-2 text-primary mb-3"><i class="bi bi-info-circle me-2"></i>Basic Information</h5>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('package_quantity') is-invalid @enderror" 
                               id="package_quantity" name="package_quantity" value="{{ old('package_quantity') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('maturity') is-invalid @enderror" name="maturity" id="maturity">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-md-2">
                                                ...
                                                <input type="number" step="0.01" id="rate_{{$index}}" name="rates[]" 
                                            ...
                                            <div class="col-md-2">
                                                <label for="time_{{$index}}" class="form-label">Time (years)</label>
                                                <input type="number" step="0.01" id="time_{{$index}}" name="times[]" 
                                            ...
                                            <div class="col-md-3">
                                                <label for="capital_{{$index}}" class="form-label">Capital Return</label>
                                                <input type="text" id="capital_{{$index}}" name="capitals[]" 
                                            ...
                                            <div class="col-md-3">
                                                <label for="profit_{{$index}}" class="form-label">Profit Share</label>
                                                <select class="form-select @error('profit_shares.'.$index) is-invalid @enderror" 
                                                        id="profit_{{$index}}" name="profit_shares[]">
                                                    <option value="" selected disabled>Select option</option>
                                                    <option value="0" {{ old('profit_shares.'.$index) == '0' ? 'selected' : '' }}>No</option>
                                                    <option value="1" {{ old('profit_shares.'.$index) == '1' ? 'selected' : '' }}>Yes</option>
                                                </select>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" step="0.01" id="rate_0" name="rates[]" class="form-control" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="time_0" class="form-label">Time (years)</label>
                                            <input type="number" step="0.01" id="time_0" name="times[]" class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="capital_0" class="form-label">Capital Return</label>
                                            <input type="text" id="capital_0" name="capitals[]" class="form-control">
                                        </div>
                                        <div class="col-md-3">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.classList.contains('remove-rate') || e.target.closest('.remove-rate')) {
                const btn = e.target.classList.contains('remove-rate') ? e.target : e.target.closest('.remove-rate');
        ...
        document.getElementById('packageForm').addEventListener('submit', function(e) {
            ...
            if (rateGroups.length === 0) {
                ...
                document.getElementById('add-rate-btn').scrollIntoView({ behavior: 'smooth' });
            }
        });
    });
</script>
