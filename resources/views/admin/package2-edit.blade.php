                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('package_name') is-invalid @enderror" 
                               id="package_name" name="package_name" value="{{ old('package_name', $package->package_name) }}" required>
                        @error('package_name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('package_quantity') is-invalid @enderror" 
                               id="package_quantity" name="package_quantity" value="{{ old('package_quantity', $package->package_quantity) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('maturity') is-invalid @enderror" name="maturity" id="maturity">
                            ...
                            <option value="0" {{ old('maturity', $package->maturity) == '0' ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('maturity', $package->maturity) == '1' ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('maturity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select @error('profit_shares.'.$index) is-invalid @enderror" 
                                                        name="profit_shares[]">
                                                    <option value="" disabled>Select option</option>
                                                    <option value="0" {{ isset($oldProfitShares[$index]) && $oldProfitShares[$index] == '0' ? 'selected' : '' }}>No</option>
                                                    <option value="1" {{ isset($oldProfitShares[$index]) && $oldProfitShares[$index] == '1' ? 'selected' : '' }}>Yes</option>
                                                </select>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">Capital Return</label>
                                                <input type="text" name="capitals[]" 
                                                       class="form-control" value="{{ $detail->capital }}">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Profit Share</label>
                                                <select class="form-select" name="profit_shares[]">
                                                    <option value="" disabled>Select option</option>
                                                    <option value="0" {{ $detail->profit_share == '0' ? 'selected' : '' }}>No</option>
                                                    <option value="1" {{ $detail->profit_share == '1' ? 'selected' : '' }}>Yes</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2 d-flex align-items-end">
                                                <button type="button" class="btn btn-outline-danger remove-rate">
