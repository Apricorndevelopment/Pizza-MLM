                            ...
                            @if($product->product_image)
                                <div class="mt-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-700">{{ $product->product_name }}</p>
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="percentage" class="block text-sm font-medium text-gray-700">
                                    <span class="text-purple-600 font-semibold">Commission (%)</span>
                                </label>
                                <div class="relative">
                                    ...
                                    <input type="number" step="0.01" name="percentage" id="percentage" 
                                           ...
                                           value="{{ old('percentage', $product->percentage ?? 0) }}">
                                </div>
                                @error('percentage')
                                    <p class="text-sm text-red-600 mt-1 flex items-center">
                                        <i class="bi bi-exclamation-circle mr-1"></i>
                        ...
                        <div class="mt-6 space-y-2">
                            ...
                            <select name="status" id="status" 
                                ...
                                <option value="approved" {{ old('status', $product->status) == 'approved' ? 'selected' : '' }}>
                                    <i class="bi bi-check-circle"></i> Approved
                                </option>
                                <option value="rejected" {{ old('status', $product->status) == 'rejected' ? 'selected' : '' }}>
