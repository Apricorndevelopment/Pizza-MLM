    ...
    <div class="container py-3">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white py-2">
                <h5 class="mb-0"><i class="fas fa-cube me-2"></i>My Packages</h5>
            </div>
            <div class="card-body p-0">
                @if ($packages->isEmpty())
                    <div class="alert alert-info m-3">You don't have any packages yet.</div>
                @else
                    <div class="table-responsive">
                        <table class="table table-hover package-table mb-0">
                            ...
                            <tbody>
                                @foreach ($packages as $index => $transaction)
                                    <tr>
                                        ...
                                        <td class="text-start fw-medium">₹{{ number_format($transaction->final_price, 2) }}</td>
