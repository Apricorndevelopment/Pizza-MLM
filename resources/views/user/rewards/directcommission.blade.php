    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-coins me-2"></i>Direct Referral Commissions
                </h4>
                <span class="badge bg-white text-primary">Level 1</span>
            </div>
        </div>
        
        <!-- Filter Section -->
        <div class="card-body border-bottom">
            <form method="GET" action="{{ route('user.commissions.level1') }}" class="row g-3 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('user.commissions.level1') }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body">
            ...
            <div class="mt-3">
                <a href="{{ route('user.commissions.level2') }}" class="btn btn-sm btn-outline-primary">
                    View Network Commissions <i class="fas fa-arrow-right ms-1"></i>
                </a>
            </div>
        </div>
    </div>
