            ...
            <div class="row g-2 g-md-3">
                @foreach ($adminProducts as $prod)
                    <div class="col-6 col-md-4 col-lg-3 mb-3">
                        <div
                            class="h-100 max-w-sm rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 ease-in-out bg-white border border-transparent hover:border-[#DBF5EC] group flex flex-col">
                            ...
                            <div class="relative overflow-hidden rounded-t-xl bg-gray-100 aspect-[4/3]">
                                ...
                                {{-- Price Overlay --}}
                                <div
                                    class="absolute bottom-0 left-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent w-full p-2 pt-6 flex items-end justify-between">
                                    <div>
                                        <p
                            ...
                            <div class="p-2 md:p-3 flex flex-col justify-between flex-grow">
                                <div class="mb-2">
                                    <h3 class="font-bold text-sm md:text-base text-gray-800 leading-tight line-clamp-2 min-h-[2.5em]"
    ...
    <div class="mb-5">
        ...
        <div class="row g-2 g-md-3">
            @foreach ($vendorProducts as $prod)
                <div class="col-6 col-md-4 col-lg-3 mb-3">
                    <div
                        class="h-100 max-w-sm rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 ease-in-out bg-white border border-transparent hover:border-red-100 group flex flex-col">
                        ...
                        <div class="relative overflow-hidden rounded-t-xl bg-gray-100 aspect-[4/3]">
                            ...
                            {{-- Vendor Badge --}}
                            <div
                                class="absolute top-1.5 right-1.5 bg-white/95 backdrop-blur-sm px-1.5 py-0.5 rounded text-[9px] md:text-[10px] font-bold shadow-sm text-gray-700 max-w-[80%] truncate">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div class="flex items-baseline gap-1">
                                        <span
                                            class="text-white font-extrabold text-lg md:text-xl tracking-tighter shadow-black drop-shadow-md">
                                            ₹{{ number_format($prod->dp) }}
                                        </span>
                                        <span
                                            class="text-gray-400 text-[10px] md:text-xs line-through decoration-red-400">₹{{ number_format($prod->mrp) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@if ($adminProducts->isEmpty() && $vendorProducts->isEmpty())
    <div class="text-center py-10">
        ...
        <button onclick="window.location.reload()" class="mt-4 text-primary text-sm font-semibold hover:underline">Clear
            Filters</button>
    </div>
@endif
