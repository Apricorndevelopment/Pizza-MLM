    ...
    <div class="container py-4" >
        <div class="card border-0 shadow-lg" id="invoiceArea">
            <div class="card-body p-4">
                ...
                <div class="row mb-4">
                    <div class="col-sm-6">
                        <h5 class="text-uppercase border-bottom pb-2 mb-3">Bill To</h5>
                        <p class="mb-1"><strong>Name:</strong> {{ Auth::user()->name }}</p>
                        <p class="mb-1"><strong>Username:</strong> {{ Auth::user()->ulid }}</p>
                        <p class="mb-0"><strong>Email:</strong> {{ Auth::user()->email }}</p>
                    </div>
                    <div class="col-sm-6">
                        <h5 class="text-uppercase border-bottom pb-4 mb-3"></h5>
                        <p class="mb-1"><strong>Phone No.:</strong> {{ Auth::user()->phone ?? 'Not Provided' }}</p>
                        <p class="mb-1"><strong>Address:</strong> {{ Auth::user()->address }}, {{ Auth::user()->state }} </p>
                    </div>
                </div>
