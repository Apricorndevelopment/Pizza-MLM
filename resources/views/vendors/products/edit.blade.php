                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="flex items-center space-x-2">
                            <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">Status</span>
                            <span class="font-medium">{{ ucfirst($product->status) }}</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <span class="bg-purple-100 text-purple-800 text-xs font-semibold px-2.5 py-0.5 rounded">Max Coupons</span>
                            <span class="font-medium">{{ $product->max_coupon_usage ?? 0 }}</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <span class="bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded">PV</span>
                            ...
                            @if($product->product_image)
                                <div class="mt-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-700">{{ basename($product->product_image) }}</p>
