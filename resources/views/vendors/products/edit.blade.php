...
@section('container')
            ...
            <div class="p-6">
                <form action="{{ route('vendor.products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                @if ($product->product_image)
                                    <div class="mt-2 p-2 bg-gray-50 rounded-lg border border-gray-200">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <img id="edit_preview_img" src="{{ asset($product->product_image) }}"
                                                alt="{{ $product->product_name }}"
                                                class="w-auto h-20 object-cover rounded-lg border border-gray-300">
                                            <div>
                                                <p class="text-sm text-gray-700" id="file_name_label">{{ basename($product->product_image) }}
                                                </p>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="isVeg" id="isVeg" class="form-select w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <script>
        function previewEditImage(event) {
            ...
            const imageField = document.getElementById('edit_preview_img');
            const nameField = document.getElementById('file_name_label');
            ...
            if(event.target.files[0]) {
                ...
                nameField.textContent = event.target.files[0].name; // Update text to new filename
            }
        }
    </script>
@endsection