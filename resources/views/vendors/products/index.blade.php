    ...
    <div class="max-w-7xl mx-auto">
        <div class="sm:flex sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-700">A list of all your products including their name, price, and status.</p>
            </div>
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('vendor.products.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex-shrink-0 h-12 w-12">
                                    @if($product->product_image)
                                        <img class="h-12 w-12 rounded-lg object-cover shadow-sm border border-gray-100" src="{{ asset($product->product_image) }}" alt="">
                                    @else
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                <a href="{{ route('vendor.products.show', $product->id) }}" class="text-blue-600 hover:text-blue-900 bg-blue-50 px-3 py-1.5 rounded-md hover:bg-blue-100 transition-colors">View</a>
                                <a href="{{ route('vendor.products.edit', $product->id) }}" class="text-amber-600 hover:text-amber-900 bg-amber-50 px-3 py-1.5 rounded-md hover:bg-amber-100 transition-colors">Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
